...
const SponsorAddOnTypes = () => {
  ...
  const callSponsorAddOnTypeListApi = () => {
    ...
    fetch(`https://harsh7541.pythonanywhere.com/admin1/sponsorpackageaddontypes`, requestOptions)
  ...
  const onDeleteButtonClick = (value) => {
    if (value) {
      ...
      fetch(
        'https://harsh7541.pythonanywhere.com/admin1/deletesponsoraddontype',
        requestOptions
      )
        .then((response) => response.json())
        .then((data) => {
