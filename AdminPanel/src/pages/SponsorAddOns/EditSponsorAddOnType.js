...
const EditSponsorAddOnType = ({
  ...
  useEffect(() => {
    if (row) {
      setAddOnType(row?.addOnTypeName);
    }
  }, [location]);
  ...
  const submitBtnClk = (e) => {
    ...
    if (addOnType === "") {
      ...
      fetch(
        "https://harsh7541.pythonanywhere.com/admin1/editsponsoraddontype",
        requestOptions
      )
...
export default EditSponsorAddOnType;
