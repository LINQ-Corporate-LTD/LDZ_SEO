...
const JoinedDelegates = () => {
  ...
  const callDelegateListApi = () => {
    setloading(true);

    const requestOptions = {
      method: "GET",
    };
    fetch(`https://harsh7541.pythonanywhere.com/admin1/joineddelegates`, requestOptions)
      ...
      .then((data) => {
        ...
        if (data && data.status) {
          setDelegateList(data["joiedDelegates"]);
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Delegates" pageTitle="Dashboards" pageLink="/dashboard" />
          <Row>
            <Col lg={12}>
                ...
                <CardHeader className="border-0">
                  <div className="d-flex align-items-center">
                    <div className="flex-grow-1">
                      <h5 className="card-title mb-0 fs-15">Delegate List</h5>
                    </div>
                    {/* {permissions?.create && ( */}
                  ...
                  <div className="mt-3">
                    {delegateList && delegateList?.length > 0 ? (
                      <TableContainer
                        ...
                        isAddUserList={false}
                        apiCallFunction={callDelegateListApi}
                        customPageSize={10}
...
export default JoinedDelegates;
