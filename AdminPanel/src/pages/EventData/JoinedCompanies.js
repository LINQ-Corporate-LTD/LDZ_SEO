...
const JoinedCompanies = () => {
  ...
  const callCompanyListApi = () => {
    setloading(true);

    const requestOptions = {
      method: "GET",
    };
    fetch(`https://www.linq-staging-site.com/admin1/joinedcompanies`, requestOptions)
      ...
      .then((data) => {
        ...
        if (data && data.status) {
          setCompanyList(data["joiedCompanies"]);
    ...
    () => [
      {
        ...
        accessorKey: "relatedPurchaseDetails.deligatePackageName",
        filterable: false,
      },
      {
        id: "companyNameId",
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Companies" pageTitle="Dashboards" pageLink="/dashboard" />
          <Row>
            <Col lg={12}>
                ...
                <CardHeader className="border-0">
                  <div className="d-flex align-items-center">
                    <div className="flex-grow-1">
                      <h5 className="card-title mb-0 fs-15">Company List</h5>
                    </div>
                    {/* {permissions?.create && ( */}
                  ...
                  <div className="mt-3">
                    {companyList && companyList?.length > 0 ? (
                      <TableContainer
                        ...
                        isAddUserList={false}
                        apiCallFunction={callCompanyListApi}
                        customPageSize={10}
