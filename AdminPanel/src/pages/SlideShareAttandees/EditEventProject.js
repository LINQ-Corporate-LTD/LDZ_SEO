...
const EditEventProject = ({
  ...
  const submitBtnClk = (e) => {
    ...
    if (projectYear === "") {
      ...
      fetch(
        "https://api.linq-staging-site.com/admin1/editeventproject",
        requestOptions,
      )
...
export default EditEventProject;
