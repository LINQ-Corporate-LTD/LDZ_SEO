...
const AddIndustryTrend = (props) => {
  ...
  const { addIndustryTrendModal } = props;
  ...
  const submitBtnClk = (e) => {
    ...
    if (trendTitle === "") {
      ...
      fetch("https://harsh7541.pythonanywhere.com/admin1/addindustrytrends", requestOptions)
...
export default AddIndustryTrend;
