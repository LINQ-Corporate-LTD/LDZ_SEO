...
const override = css`
  ...
  height: 100%;
`;
const AddRelatedEvent = (props) => {
  const navigate = useNavigate();
  const { addRelatedEventModal } = props;
  ...
  const submitBtnClk = (e) => {
    ...
    if (eventName === "") {
      ...
      fetch("https://harsh7541.pythonanywhere.com/admin1/addrelatedevent", requestOptions)
...
export default AddRelatedEvent;
