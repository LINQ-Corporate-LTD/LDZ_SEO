...
const EditExpertSpeaker = ({
  ...
  useEffect(() => {
    if (row) {
      setExpertSpeakerName(row?.expertSpeakerName);
      setExpertSpeakerCompanyName(row?.expertSpeakerCompany);
    }
  }, [location]);
  ...
  const submitBtnClk = (e) => {
    ...
    if (expertSpeakerName === "") {
      ...
      fetch("https://api.linq-staging-site.com/admin1/editexpertspeaker", requestOptions)
...
export default EditExpertSpeaker;
