  ...
  const callResponseListApi = () => {
    ...
    fetch(`https://api.linq-staging-site.com/admin1/becomespeakerresponses`, requestOptions)
      ...
      .then((data) => {
        ...
        if (data && data.status) {
          setResponseList(data["becomeSpeakerList"]);
...
export default BecomeSpeakerResponse;
