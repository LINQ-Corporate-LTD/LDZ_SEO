...
const override = css`
  ...
  height: 100%;
`;
const EditAddOns = ({ row, editModal, onCloseModal, onModalSubmitBtnClk }) => {
  console.log("row: ", row);
  ...
  useEffect(() => {
    if (row) {
      setTitle(row?.addOnPointName);
      setPrice(row?.additionalPrice);
    }
  }, [location]);
  ...
  const submitBtnClk = (e) => {
    ...
    if (title === "") {
      ...
      fetch(
        "https://harsh7541.pythonanywhere.com/admin1/editdelegatepackageaddons",
        requestOptions
      )
          ...
          <ModalBody>
            ...
            <div className="row gy-4 mb-3">
              ...
              <div className="col-md-12">
                <div>
                  <Label htmlFor="customername-field" className="form-label">
                    Additonal Price <span className="required_span">*</span>
                  </Label>
                  <Input
                    type="text"
