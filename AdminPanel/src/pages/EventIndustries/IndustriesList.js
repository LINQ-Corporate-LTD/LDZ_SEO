...
const IndustriesList = () => {
  ...
  const callIndustryListApi = () => {
    ...
    fetch(`https://api.linq-staging-site.com/admin1/eventparticipatedindustries`, requestOptions)
  ...
  const onDeleteButtonClick = (value) => {
    if (value) {
      ...
      fetch(
        'https://api.linq-staging-site.com/admin1/deleteeventparticipatedindustry',
        requestOptions
      )
        .then((response) => response.json())
        .then((data) => {
