  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://api.linq-staging-site.com" + "/admin1/customlogin", { email, password });
      ...
      if (response.status) {
        ...
        try {
          const navResponse = await axios.get("https://api.linq-staging-site.com" + "/admin1/getnavbardata");
