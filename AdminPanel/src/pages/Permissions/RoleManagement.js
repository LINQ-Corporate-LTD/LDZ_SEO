...
const RoleManagement = () => {
    ...
    const fetchRoles = () => {
        setLoading(true);
        fetch("https://harsh7541.pythonanywhere.com/admin1/rolelist")
            .then((res) => res.json())
            .then((data) => {
                if (data.status) {
    ...
    const validation = useFormik({
        ...
        onSubmit: (values) => {
            ...
            fetch("https://harsh7541.pythonanywhere.com/admin1/addrole", {
                method: "POST",
                body: formData,
            })
                .then((res) => res.json())
    ...
    const handleDeleteRole = (id) => {
        if (window.confirm("Are you sure you want to delete this role?")) {
            fetch("https://harsh7541.pythonanywhere.com/admin1/deleterole", {
                method: "POST",
