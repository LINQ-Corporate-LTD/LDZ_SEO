...
const AddSlideShare = (props) => {
  ...
  const { addSlideShareModal } = props;
  ...
  const submitBtnClk = (e) => {
    ...
    // }
      ...
      fetch(
        "https://linq-staging-site.com/admin1/addslideShare",
        requestOptions,
      )
        .then((response) => response.json())
        .then((data) => {
