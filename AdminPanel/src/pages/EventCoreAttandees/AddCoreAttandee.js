...
const override = css`
  ...
  height: 100%;
`;
const AddCoreAttandee = (props) => {
  const navigate = useNavigate();
  const { addCoreAttandeeModal } = props;
  ...
  const submitBtnClk = (e) => {
    ...
    if (coreAttandeeName === "") {
      ...
      fetch("https://api.linq-staging-site.com/admin1/addeventcoreattandee", requestOptions)
...
export default AddCoreAttandee;
