...
const EditNavSubCategory = ({
  ...
  const callMainCategoryListApi = () => {
    ...
    fetch(`https://www.linq-staging-site.com/admin1/navmaincategories`, requestOptions)
  ...
  const submitBtnClk = (e) => {
    ...
    if (selectedMainCategory === null) {
      ...
      fetch("https://www.linq-staging-site.com/admin1/editnavsubcategory", requestOptions)
        .then((response) => response.json())
        .then((data) => {
          if (
            data &&
