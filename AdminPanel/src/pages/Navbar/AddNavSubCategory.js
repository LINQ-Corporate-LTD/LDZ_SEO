...
const AddNavSubCategory = (props) => {
  ...
  const [selectedMainCategoryError, setSelectedMainCategoryError] = useState(false);
  ...
  const callMainCategoryListApi = () => {
    ...
    fetch(
      `https://harsh7541.pythonanywhere.com/admin1/navmaincategories`,
      requestOptions
    )
  ...
  const submitBtnClk = (e) => {
    ...
    if (selectedMainCategory === null) {
      ...
      fetch(
        "https://harsh7541.pythonanywhere.com/admin1/addnavsubcategory",
        requestOptions
      )
        .then((response) => response.json())
        .then((data) => {
...
export default AddNavSubCategory;
