...
const NavSubCategories = () => {
  ...
  const callSubCategoryListApi = () => {
    ...
    fetch(`https://harsh7541.pythonanywhere.com/admin1/navsubcategories`, requestOptions)
  ...
  const onDeleteButtonClick = (value) => {
    if (value) {
      ...
      fetch("https://harsh7541.pythonanywhere.com/admin1/deletenavsubcategory", requestOptions)
        .then((response) => response.json())
        .then((data) => {
          if (
            data &&
