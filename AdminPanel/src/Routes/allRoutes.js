...
import EventSpeakerList from "../pages/EventSpeakers/EventSpeakerList";
import EventSponsorList from "../pages/EventSponsors/EventSponsorList";
import EventKeyPointList from "../pages/EventKeyPoints/EventKeyPointList";
import EventTestimonials from "../pages/EventTestimonials/EventTestimonials";
import EventSubscriber from "../pages/EventSubscriber";
import EventContactUsResponse from "../pages/EventContactUsResponce";
import IndustryTrendList from "../pages/IndustryTrends/IndustryTrendList";
import RelatedEvents from "../pages/RelatedEvents/RelatedEvents";
import Tagline_Contain from "../pages/TaglineContain/Tagline_Contain";
import VenueContain from "../pages/VenueContain/VenueContain";
import ContactUsHelpers from "../pages/ContactUs/ContactUsHelpers";
import EventPastAttandeeList from "../pages/EventPastAttandees/EventPastAttandeeList";
import DelegatePackageList from "../pages/DelegatePackages/DelegatePackageList";
import SponsorPackageList from "../pages/SponsorPackages/SponsorPackageList";
import EventStataticsList from "../pages/EventStatatics/EventStataticsList";
import LogoList from "../pages/EventLogoSlider/LogoList";
import NewsCategoryList from "../pages/News/NewsCategoryList";
import EventNewsList from "../pages/EventNews/EventNewsList";
import FaqsList from "../pages/EventFaqs/FaqsList";
import WhoShouldAttendContent from "../pages/WhoShouldAttendContent/WhoShouldAttendContent";
import SpeakerPageContent from "../pages/SpeakerPageContent/SpeakerPageContent";
import ContactUsPageContent from "../pages/ContactUs/ContactUsPageContent";
import CoreAttandeesList from "../pages/EventCoreAttandees/CoreAttandeesList";
import IndustriesList from "../pages/EventIndustries/IndustriesList";
import MediaPageHelpers from "../pages/MediaPage/MediaPageHelpers";
import SponsorPageContent from "../pages/EventSponsors/SponsorPageContent";
import StandOutCrowdResponse from "../pages/StandOutCrowdResponse";
import BecomeSpeakerResponse from "../pages/BecomeSpeakerResponse";
import QuickProposalResponse from "../pages/QuickProposalResponse";
import ExpertSpeakers from "../pages/EventExpertSpeakers/ExpertSpeakers";
import UserPassRegistration from "../pages/UserPassRegistration";
import HomePastAttandeeList from "../pages/HomePastAttandees/HomePastAttandeeList";
import EventLeaders from "../pages/EventLeaders/EventLeaders";
import OfferCouponList from "../pages/OfferCoupons/OfferCouponList";
import AddAddOns from "../pages/DelegateAddOns/AddAddOns";
import AddOnsList from "../pages/DelegateAddOns/AddOnsList";
import SponsorAddOnTypes from "../pages/SponsorAddOns/SponsorAddOnTypes";
import SponsorAddOnsList from "../pages/SponsorAddOns/SponsorAddOnsList";
import AddAgenda from "../pages/Agenda/AddAgenda";
import MainCategories from "../pages/Navbar/MainCategories";
import NavSubCategories from "../pages/Navbar/NavSubCategories";
import AddEventData from "../pages/EventData/AddEventData";
import EventData from "../pages/EventData/EventData";
import SocilMediaList from "../pages/SocialMedia/SocialMediaList";
import AddSocialMediaOption from "../pages/SocialMedia/AddSocialMediaOption";
import AgendaList from "../pages/Agenda/AgendaList";
import EditAgenda from "../pages/Agenda/EditAgenda";
import JoinedDelegates from "../pages/EventData/JoinedDelegates";
import JoinedCompanies from "../pages/EventData/JoinedCompanies";
import EventCompanyTransections from "../pages/EventData/EventCompanyTransections";
import JoinedSponsors from "../pages/EventData/JoinedSponsors";
...
const authProtectedRoutes = [
  ...
  // WDRM Modules
  { path: "/eventspeakers", component: <EventSpeakerList /> },
  { path: "/eventsponsors", component: <EventSponsorList /> },
  { path: "/eventkeytopics", component: <EventKeyPointList /> },
  { path: "/eventtestimonials", component: <EventTestimonials /> },
  { path: "/eventsubscribers", component: <EventSubscriber /> },
  { path: "/contactusrespone", component: <EventContactUsResponse /> },
  { path: "/industrytrends", component: <IndustryTrendList /> },
  { path: "/relatedevents", component: <RelatedEvents /> },
  { path: "/taglinecontent", component: <Tagline_Contain /> },
  { path: "/venuecontent", component: <VenueContain /> },
  { path: "/contactusperson", component: <ContactUsHelpers /> },
  { path: "/eventpastattandees", component: <EventPastAttandeeList /> },
  { path: "/delegatepackages", component: <DelegatePackageList /> },
  { path: "/sponsorpackages", component: <SponsorPackageList /> },
  { path: "/eventstatatics", component: <EventStataticsList /> },
  { path: "/sliderlogos", component: <LogoList /> },
  { path: "/newscategories", component: <NewsCategoryList /> },
  { path: "/news", component: <EventNewsList /> },
  { path: "/faqs", component: <FaqsList /> },
  { path: "/whoshouldattend", component: <WhoShouldAttendContent /> },
  { path: "/speakerpagecontent", component: <SpeakerPageContent /> },
  { path: "/contactuspagecontent", component: <ContactUsPageContent /> },
  { path: "/coreattandees", component: <CoreAttandeesList /> },
  { path: "/industries", component: <IndustriesList /> },
  { path: "/mediapagecompanypersons", component: <MediaPageHelpers /> },
  { path: "/sponsorpagecontent", component: <SponsorPageContent /> },
  { path: "/standoutcrowdresponse", component: <StandOutCrowdResponse /> },
  { path: "/becomespeakerresponse", component: <BecomeSpeakerResponse /> },
  { path: "/quickproposalresponse", component: <QuickProposalResponse /> },
  { path: "/expertspeakers", component: <ExpertSpeakers /> },
  { path: "/userpassregistrationrequests", component: <UserPassRegistration /> },
  { path: "/homepastattandees", component: <HomePastAttandeeList /> },
  { path: "/eventleaders", component: <EventLeaders /> },
  { path: "/offercoupons", component: <OfferCouponList /> },
  { path: "/delegateaddons", component: <AddOnsList /> },
  { path: "/sponsoraddontypes", component: <SponsorAddOnTypes /> },
  { path: "/sponsoraddons", component: <SponsorAddOnsList /> },
  { path: "/addagenda", component: <AddAgenda /> },
  { path: "/navmaincategories", component: <MainCategories /> },
  { path: "/navsubcategories", component: <NavSubCategories /> },
  { path: "/addeventdata", component: <AddEventData /> },
  ...
  { path: "/companytransections", component: <EventCompanyTransections /> },
