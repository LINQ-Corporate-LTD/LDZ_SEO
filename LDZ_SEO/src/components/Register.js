...
//     fetch("https://api.linq-staging-site.com/admin1/adduserpassrequest", requestOptions)
//       .then((response) => response.json())
//       .then((data) => {
//         if (data.status) {
...
const Register = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://api.linq-staging-site.com/admin1/deligatepackageslist")
      .then((r) => r.json())
      .then((data) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://api.linq-staging-site.com/admin1/adduserpassrequest", {
      method: "POST",
      body: finalData,
    })
      .then((response) => response.json())
