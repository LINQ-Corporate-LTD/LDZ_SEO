...
<body>
    ...
    try {
      ...
      fetch(
        "https://api.linq-staging-site.com/admin1/addnewsponsor",
        requestOptions,
      )
  ...
  const callSponsorAddOnsApi = () => {
    ...
    fetch(
      `https://api.linq-staging-site.com/admin1/sponsoraddons`,
      requestOptions,
    )
      .then((response) => response.json())
      .then((data) => {
  ...
  const callGetActiveDelPackageApi = () => {
    ...
    fetch(
      `https://api.linq-staging-site.com/admin1/getactivedelegatepackage`,
      requestOptions,
    )
      .then((response) => response.json())
      .then((data) => {
  ...
  //     };
  //     fetch(
  //       `https://api.linq-staging-site.com/admin1/sponsoroffercouponbycode`,
  //       requestOptions,
  //     )
  //       .then((response) => response.json())
  //       .then((data) => {
